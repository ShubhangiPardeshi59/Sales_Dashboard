...
export default function InputFields(props) {
  ...
  const {
    ...
    value: currentRowContent["product_category"],
    isTouched: false,
  });
  ...
  const {
    ...
    value: currentRowContent["sub_category"],
    isTouched: false,
  });
  ...
  const {
    ...
    value: currentRowContent["country"],
    isTouched: false,
  });
  ...
  const {
    ...
    value: currentRowContent["quantity"],
    isTouched: false,
  });
  ...
  const {
    ...
    value: currentRowContent["unit_price"],
    isTouched: false,
  });
  ...
  const {
    ...
    value: currentRowContent["unit_cost"],
    isTouched: false,
  });
